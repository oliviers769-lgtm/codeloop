...
import Tableur from './pages/Tableur';
...
export default function App() {
  ...
  const navigate = (target, data) => {
    if (target === 'home')          { setView('home'); update({ onboardingDone: true }); }
    ...
    else if (target === 'tableur')  { setView('tableur'); }
    else if (target === 'sessionEnd') { setCurrentExercise(data); setView('sessionEnd'); }
  };
